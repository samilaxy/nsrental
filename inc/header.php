...
<head>
  ...
  <!-- Favicons -->
  <link href="../stylesheet/img/favicon.png" rel="icon">
  <link href="../stylesheet/img/apple-touch-icon.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo"><a href="index.php">NS-Rentals</a></h1>
      <!-- Uncomment below if you prefer to use an image logo
      <a href="index.html" class="logo"><img src="stylesheet/img/logo.png" alt="" class="img-fluid"></a> -->
      ...
      <nav class="nav-menu d-none d-lg-block">
        ...
        <ul>
          ...
          <li><a href="../templates/garage.php">Garage</a></li>
